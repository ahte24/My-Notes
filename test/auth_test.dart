...
void main() {
  group('Mock Authentication', () {
    ...
    test('should be able to initialized in less then 2 seconds', () async {
      await provider.initialize();
      expect(provider.isInitialized, true);
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> logIn({
    ...
    if (!isInitialized) throw NotInitializedException();
    if (email == 'ahtesham@gmail.com') throw UserNotFoundAuthException();
    if (password == 'Maz@123') throw WrongPasswordAuthException();
    const user = AuthUser(
      isEmailVerified: false,
      email: 'ahteshamzaman24@gmail.com',
    );
    _user = user;
